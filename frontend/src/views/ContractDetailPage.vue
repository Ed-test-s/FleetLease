      ...
      <div class="card p-6 mb-6">
        ...
        <template v-else>
          <div v-if="contract.psa_doc_url || contract.la_doc_url" class="space-y-2">
            <a v-if="contract.psa_doc_url" :href="contract.psa_doc_url" target="_blank" class="flex items-center gap-2 text-lg font-medium text-blue-600 hover:text-blue-800 hover:underline">
              <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              Скачать договор купли-продажи (.docx)
            </a>
            <a v-if="contract.la_doc_url" :href="contract.la_doc_url" target="_blank" class="flex items-center gap-2 text-lg font-medium text-blue-600 hover:text-blue-800 hover:underline">
              <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
