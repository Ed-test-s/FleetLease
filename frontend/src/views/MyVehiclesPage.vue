    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div v-for="v in vehicles" :key="v.id" class="card overflow-hidden relative">
        ...
        <div class="absolute top-2 right-2 flex gap-1">
          <router-link :to="`/my-vehicles/${v.id}/edit`" class="p-1.5 bg-white/90 rounded-lg hover:bg-white shadow-sm">
          ...
          <button @click="deleteVehicle(v.id)" class="p-1.5 bg-white/90 rounded-lg hover:bg-white shadow-sm">
